...
let g:colors_name="still"

hi Normal       guifg=Black     guibg=white      gui=none
hi Visual       guifg=white     guibg=#336AC5    gui=none
hi LineNr       guifg=DarkCyan  guibg=grey80
...
" hi NonText      guifg=cyan           guibg=white gui=none
...
hi Pmenu        guifg=black          guibg=#ADD6FF  gui=none
hi PmenuSel     guifg=white          guibg=#445599  gui=none
...
" hi Statement    guifg=Deeppink     	 gui=none
...
" hi ColorColumn  ctermbg=lightgrey    ctermfg=darkgreen 
